  ...
  return (
    <>
      ...
      <section className='w-full h-[30vh] border-b border-gray-300'>
        <div className='p-4 w-[80%] h-full mx-[10%] flex items-center border-x border-gray-200'>
          <div className='w-full'>
            <h3 className='font-neue font-semibold text-4xl text-gray-900'>
              Sign up for <em className='text-violet-600'>insider</em><br />
              tips and tricks
            </h3>
          </div>
